...
namespace WSC.UmbCare.Composers
{
    public class WSCUmbCareApiComposer : IComposer
    {
        public void Compose(IUmbracoBuilder builder)
        {
            ...
            builder.Services.Configure<SwaggerGenOptions>(opt =>
            {
                ...
                {
                    Title = "WSCUmb Care Backoffice API",
                    Version = "1.0",
                ...
                opt.OperationFilter<WSCUmbCareOperationSecurityFilter>();
            });
        }

        public class WSCUmbCareOperationSecurityFilter : BackOfficeSecurityRequirementsOperationFilterBase
        {
        ...
        public class CustomOperationHandler : OperationIdHandler
        {
            ...
            {
                return controllerActionDescriptor.ControllerTypeInfo.Namespace?.StartsWith("WSC.UmbCare.Controllers", comparisonType: StringComparison.InvariantCultureIgnoreCase) is true;
            }
